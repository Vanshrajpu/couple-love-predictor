...
.app-name{font-size:20px; font-weight:800; letter-spacing:-0.5px; color:#0f172a;}
.app-tag{font-size:11px; color:#64748b; font-weight:600;}
...
with col_logo:
    # Agar logo.png hai to wo dikhega, nahi to 💘 wala
    if os.path.exists("logo.png"):
        c1,c2 = st.columns([0.08,0.92])
        with c1: st.image("logo.png", width=48)
        with c2: st.markdown('<div class="app-name">BondIQ</div><div class="app-tag">Couple Compatibility Engine • Vansh Rajput • FAANG UI • Powered by couple_love_model.pkl</div>', unsafe_allow_html=True)
    else:
        st.markdown("""
        <div class="nav">
          <div style="display:flex; gap:14px; align-items:center;">
            ...
            <div>
              <div class="app-name">BondIQ — Couple Compatibility Engine</div>
              <div class="app-tag">Explainable AI • 91.2% Accuracy • Vansh Rajput • FAANG Animated</div>
            </div>
          </div>
